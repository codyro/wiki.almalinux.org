...
The [official AlmaLinux OS images](https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=AlmaLinux) are available via the Azure Marketplace at the link provided.
